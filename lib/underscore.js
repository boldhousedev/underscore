...
(function (global, factory) {
  ...
  _.defaults2 = function (o, d) {
    ...
    _.map(o, function (i, k) {
      return (_.isJSON(i) || _.isArray(i)) && (_.isJSON(d[k]) || _.isArray(d[k])) ? k2.push(k) : k1.push(k);
    });

    _.map(d, function (i, k) {
      return (_.isJSON(i) || _.isArray(i)) && (_.isJSON(o[k]) || _.isArray(o[k])) ? kd2.push(k) : kd1.push(k);
    });
    ...
    if (_.size(od2)) {
      _.map(od2, function (i, k) {
        if (_.indexOf(keys, k) !== -1 || _.isArray(o2[k]) && _.isObject(od2[k]) || _.isObject(o2[k]) && _.isArray(od2[k])) {
          return;
        }
